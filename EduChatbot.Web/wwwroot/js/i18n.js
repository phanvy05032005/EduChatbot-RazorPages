...
(function () {
    ...
    const VI = {
        ...
        'docs.upload.progressTitle': 'Đang tải lên tài liệu...',
        'docs.upload.processingTitle': 'Đang xử lý tài liệu...',
        'docs.upload.uploadingStatus': 'Đang tải tệp lên máy chủ...',
        'docs.upload.status0': 'Tải lên hoàn tất. Đang xử lý tài liệu...',
        'docs.upload.status1': 'Đang trích xuất nội dung văn bản từ tài liệu...',
        'docs.upload.status2': 'Đang phân tách nội dung thành các đoạn dữ liệu...',
        'docs.upload.status3': 'Đang chuẩn bị dữ liệu tri thức cho chatbot...',
        'docs.upload.status4': 'Đang hoàn tất thiết lập tài liệu...',
        'docs.upload.longWait': 'Quá trình này đang mất nhiều thời gian hơn bình thường tùy thuộc vào kích thước tệp và xử lý AI. Vui lòng không đóng hoặc tải lại trang này.',
        'quizzes.generate.loadingTitle': 'Đang tạo bài trắc nghiệm...',
        'quizzes.generate.btnGenerating': 'Đang tạo...',
        'quizzes.generate.elapsedTime': 'Thời gian đã trôi qua: {0}s',
        'quizzes.generate.status0': 'Đang phân tích nội dung tài liệu...',
        'quizzes.generate.status1': 'Đang khởi tạo các câu hỏi trắc nghiệm...',
        'quizzes.generate.status2': 'Đang chuẩn bị các phương án lựa chọn và đáp án...',
        'quizzes.generate.status3': 'Đang cấu trúc bản nháp bài thi...',
        'quizzes.generate.status4': 'Đang hoàn tất chi tiết bài trắc nghiệm...',
        'quizzes.generate.longWait': 'Quá trình tạo đề đang mất nhiều thời gian hơn bình thường do AI đang xử lý nội dung tài liệu lớn. Vui lòng không đóng hoặc tải lại trang này.',
        'quizzes.generate.loadingTitle': 'Đang tạo bài trắc nghiệm...',
        'quizzes.generate.loadingDesc': 'Đang sinh danh sách câu hỏi và các phương án trả lời. Việc này có thể mất tới một phút.',
        ...
        'student.sidebar.purchaseHistory': 'Lịch sử thanh toán',
        'admin.sidebar.payments': 'Quản lý thanh toán',
        'subscription.history.title': 'Lịch sử thanh toán',
        'subscription.history.subtitle': 'Xem lại tất cả các giao dịch thanh toán gói Premium, theo dõi kết quả thanh toán và thời gian hết hạn.',
        'subscription.history.myTransactions': 'Giao dịch của tôi',
        'subscription.history.transactionsFound': 'giao dịch được tìm thấy',
        'subscription.history.page': 'Trang',
        'subscription.history.emptyTitle': 'Chưa có lịch sử thanh toán',
        'subscription.history.emptyDesc': 'Các khoản thanh toán Premium thành công, đang chờ xử lý, thất bại hoặc bị hủy của bạn sẽ hiển thị ở đây.',
        'subscription.history.browsePlans': 'Xem các gói cước',
        'subscription.history.table.createdAt': 'Ngày tạo',
        'subscription.history.table.package': 'Gói dịch vụ',
        'subscription.history.table.amount': 'Số tiền',
        'subscription.history.table.method': 'Phương thức',
        'subscription.history.table.orderCode': 'Mã đơn hàng',
        'subscription.history.table.status': 'Trạng thái',
        'subscription.history.table.paidAt': 'Ngày thanh toán',
        'subscription.history.table.expiredAt': 'Ngày hết hạn',
        'subscription.history.table.note': 'Ghi chú',
        'subscription.history.prev': 'Trước',
        'subscription.history.next': 'Sau',
        'subscription.history.showingPage': 'Hiển thị trang',
        'subscription.history.pageOf': 'trên',
        'subscription.status.paid': 'Đã thanh toán',
        'subscription.status.pending': 'Chờ thanh toán',
        'subscription.status.expired': 'Hết hạn',
        'subscription.status.failed': 'Thất bại',
        'subscription.status.cancelled': 'Đã hủy',
        'admin.payments.title': 'Quản lý thanh toán',
        'admin.payments.subtitle': 'Kiểm tra mọi giao dịch Premium, kiểm soát kết quả thanh toán và thống kê doanh thu.',
        'admin.payments.totalTransactions': 'Tổng giao dịch',
        'admin.payments.paidTransactions': 'Giao dịch thành công',
        'admin.payments.totalRevenue': 'Tổng doanh thu',
        'admin.payments.pending': 'Chờ xử lý',
        'admin.payments.failedOrCancelled': 'Thất bại / Đã hủy',
        'admin.payments.filters': 'Bộ lọc',
        'admin.payments.filtersDesc': 'Bộ lọc nhanh phía máy chủ giúp tìm kiếm giao dịch dễ dàng hơn.',
        'admin.payments.clearAll': 'Xóa bộ lọc',
        'admin.payments.search': 'Tìm kiếm',
        'admin.payments.searchPlaceholder': 'Học sinh, email, gói, mã đơn hàng...',
        'admin.payments.method': 'Phương thức',
        'admin.payments.status': 'Trạng thái',
        'admin.payments.all': 'Tất cả',
        'admin.payments.quickRange': 'Khoảng thời gian',
        'admin.payments.none': 'Không chọn',
        'admin.payments.today': 'Hôm nay',
        'admin.payments.thisWeek': 'Tuần này',
        'admin.payments.thisMonth': 'Tháng này',
        'admin.payments.last30Days': '30 ngày qua',
    ...
    const EN = {
        ...
        'docs.upload.progressTitle': 'Uploading document...',
        'docs.upload.processingTitle': 'Processing document...',
        'docs.upload.uploadingStatus': 'Uploading file to server...',
        'docs.upload.status0': 'Upload complete. Processing document...',
        'docs.upload.status1': 'Extracting text from document...',
        'docs.upload.status2': 'Splitting content into searchable chunks...',
        'docs.upload.status3': 'Preparing document for chatbot retrieval...',
        'docs.upload.status4': 'Finalizing document setup...',
        'docs.upload.longWait': 'This is taking longer than usual depending on file size and AI processing. Please do not close or reload this page.',
        'quizzes.generate.loadingTitle': 'Generating quiz...',
        'quizzes.generate.btnGenerating': 'Generating...',
        'quizzes.generate.elapsedTime': 'Elapsed time: {0}s',
        'quizzes.generate.status0': 'Analyzing document content...',
        'quizzes.generate.status1': 'Generating multiple-choice questions...',
        'quizzes.generate.status2': 'Preparing answer options and correct keys...',
        'quizzes.generate.status3': 'Structuring quiz draft...',
        'quizzes.generate.status4': 'Finalizing quiz details...',
        'quizzes.generate.longWait': 'This is taking longer than usual due to deep AI content processing. Please do not close or reload this page.',
        'quizzes.lecturer.gen.loadingTitle': 'Generating quiz...',
        ...
        'subscription.history.title': 'Purchase History',
        'subscription.history.subtitle': 'Review every Premium payment, track payment outcomes, and check when each package expires.',
        'subscription.history.myTransactions': 'My Transactions',
        'subscription.history.transactionsFound': 'transaction(s) found',
        'subscription.history.page': 'Page',
        'subscription.history.emptyTitle': 'No purchase history yet',
        'subscription.history.emptyDesc': 'Your successful, pending, failed, and cancelled Premium payments will appear here.',
        'subscription.history.browsePlans': 'Browse Plans',
        'subscription.history.table.createdAt': 'Created At',
        'subscription.history.table.package': 'Package',
        'subscription.history.table.amount': 'Amount',
        'subscription.history.table.method': 'Payment Method',
        'subscription.history.table.orderCode': 'Order Code',
        'subscription.history.table.status': 'Status',
        'subscription.history.table.paidAt': 'Paid At',
        'subscription.history.table.expiredAt': 'Expired At',
        'subscription.history.table.note': 'Note',
        'subscription.history.prev': 'Previous',
        'subscription.history.next': 'Next',
        'subscription.history.showingPage': 'Showing page',
        'subscription.history.pageOf': 'of',
        ...
        'admin.payments.subtitle': 'Inspect every Premium transaction, audit payment outcomes, and review revenue-ready paid records.',
        'admin.payments.totalTransactions': 'Total Transactions',
        'admin.payments.paidTransactions': 'Paid Transactions',
        'admin.payments.totalRevenue': 'Total Revenue',
        'admin.payments.pending': 'Pending',
        'admin.payments.failedOrCancelled': 'Failed / Cancelled',
        'admin.payments.filters': 'Filters',
        'admin.payments.filtersDesc': 'Compact server-side filters for fast transaction lookup.',
        'admin.payments.clearAll': 'Clear all',
        'admin.payments.search': 'Search',
        'admin.payments.searchPlaceholder': 'Student, email, package, order code...',
        'admin.payments.method': 'Method',
        'admin.payments.status': 'Status',
        'admin.payments.all': 'All',
        'admin.payments.quickRange': 'Quick Range',
        'admin.payments.none': 'None',
        'admin.payments.today': 'Today',
        'admin.payments.thisWeek': 'This Week',
        'admin.payments.thisMonth': 'This Month',
        'admin.payments.last30Days': 'Last 30 Days',
